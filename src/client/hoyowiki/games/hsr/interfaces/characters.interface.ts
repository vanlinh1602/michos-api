export interface HSR_Wiki_Charaters {
...
interface FilterValues {
  ...
  character_rarity: Character;
  character_factions?: Character;
  character_combat_type: Character;
}
...
export interface HSR_Wiki_Character_Detail {
  id: string;
  name: string;
  desc: string;
  icon_url: string;
