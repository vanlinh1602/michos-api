...
export const HI_RECORD_OLD_ABYSS_API = `${BBS_API}/game_record/honkai3rd/api/latestOldAbyssReport`;
export const HI_RECORD_NEW_ABYSS_API = `${BBS_API}/game_record/honkai3rd/api/newAbyssReport`;
